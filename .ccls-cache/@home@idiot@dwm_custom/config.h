...
static const char *fonts[]          = { "Meslo LG L for Powerline:style=Bold:size=12" };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = SHCMD("roxterm -e fish") } },
	...
	{ MODKEY,                       XK_r,      spawn,         {.v = SHCMD("rofi -show drun")} },
