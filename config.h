...
static const char *fonts[]          = { "Meslo LG L for Powerline:style=Bold:size=14" };
static const char dmenufont[]       = "CommitMono Nerd Font:style=Bold:size=12";
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Return, spawn,          {.v = SHCMD("roxterm -e fish") } },
